...
class SurfaceClassifier(nn.Module):
    def __init__(self, filter_channels, merge_layer=0, num_views=1, no_residual=True, last_op=None):
    ...
    def forward(self, feature):
        ...
        for i, f in enumerate(self.filters):
            ...
            if self.merge_layer != 0 and i == self.merge_layer:
                phi = y.clone()
